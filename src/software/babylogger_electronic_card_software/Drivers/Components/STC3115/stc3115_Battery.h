...
#define CAPACITY		950	/* battery nominal capacity in mAh					*/
...
#define ALM_SOC			25			/* SOC alarm in % 								*/
#define ALM_VBAT 		3600		/* Voltage alarm in mV							*/
#define RSENSE			10			/* sense resistor in mOhms 						*/

#define APP_EOC_CURRENT       45   		/* end charge current in mA                 */
#define APP_CUTOFF_VOLTAGE	  3000   	/* application cut-off voltage in mV 3660     	*/
