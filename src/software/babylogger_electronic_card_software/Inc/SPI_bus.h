...
#define BUS_SPI3_INSTANCE SPI1
#define BUS_SPI3_SCK_GPIO_PIN GPIO_PIN_5
#define BUS_SPI3_SCK_GPIO_AF GPIO_AF5_SPI1
...
#define BUS_SPI3_MISO_GPIO_PIN GPIO_PIN_6
#define BUS_SPI3_MISO_GPIO_AF GPIO_AF5_SPI1
...
#define BUS_SPI3_MOSI_GPIO_PIN GPIO_PIN_7
#define BUS_SPI3_MOSI_GPIO_AF GPIO_AF5_SPI1
#define BUS_SPI3_MOSI_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_SPI3_MOSI_GPIO_PORT GPIOA
#define BUS_SPI3_MOSI_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
