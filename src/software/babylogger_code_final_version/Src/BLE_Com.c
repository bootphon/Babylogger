...
{  
  ...
  uint8_t manuf_data[29] = {
    ...
    11,0x09,SENSOR_DEMO_NAME,  // Complete Name
  ...
  manuf_data[21] |= 0x01; /* Sensor Fusion */
      ...
      case EVT_BLUE_GATT_WRITE_PERMIT_REQ:
        {
          ...
          Write_Request_CB(pr->conn_handle,pr->attr_handle,pr->data_length,pr->data);   
        ...
        break;
			case EVT_BLUE_GATT_ATTRIBUTE_MODIFIED:
				...
				{
					evt_gatt_attr_modified_IDB05A1 *prs = (void*)blue_evt->data;
